    ...
    function zoomed() {
        ...
        imageWater.enter().append("svg")
            ...
            .each(function (d) {
                ...
                //                        url = "https://" + ["a", "b", "c"][(d[0] * 31 + d[1]) % 3] + ".tile.openstreetmap.org/vectiles-highroad/" + d[2] + "/" + d[0] + "/" + d[1] + ".json";
                    url = "https://" + ["a", "b", "c"][(d[0] * 31 + d[1]) % 3] + ".t/applications/" + openStreetMapType + "/" + d[2] + "/" + d[0] + "/" + d[1] + ".json";
        ...
        imageRoads.enter().append("svg")
            ...
            .each(function (d) {
                ...
                //                        url = "https://" + ["a", "b", "c"][(d[0] * 31 + d[1]) % 3] + ".tile.openstreetmap.org/vectiles-highroad/" + d[2] + "/" + d[0] + "/" + d[1] + ".json";
                    url = "https://" + ["a", "b", "c"][(d[0] * 31 + d[1]) % 3] + ".tile.openstreetmap.org/" + openStreetMapType + "/" + d[2] + "/" + d[0] + "/" + d[1] + ".json";
                this._xhr = d3.json(url, function (error, json) {
                    var k = Math.pow(2, d[2]) * 256; // size of the world in pixels
